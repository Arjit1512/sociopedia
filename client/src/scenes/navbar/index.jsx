  ...
  return (
    <FlexBetween padding="1rem 6%" backgroundColor={alt}>
         <FlexBetween gap="1.75rem">
             ...
             onClick={() => navigate("/home")}  /*CLAMP OCHESI RESPONSIVE KOSAM VAADTAM i.e, for mobiles-font size ochesi 1rem and so on..*/
             sx={{"&:hover":{     /* 'SX' OCHESI REACT LO INLINE CSS KOSAM VAADTAM*/
              color:primaryLight,
              cursor:"pointer",
             },
           ...
           {isNonMobileScreens && (
            ...
            {isNonMobileScreens ? (<FlexBetween gap="2rem">
              ...
              <FormControl variant="standard" value={fullName}>  {/*FORMCONTROL OCHESI DROP-DOWN MENU KOSAM VAADTAM*/}
             ...
             {!isNonMobileScreens && isMobileMenuToggled && (
              <Box position="fixed" right="0" bottom="0" height="100%" zIndex="10" maxWidth="500px" minWidth="300px" backgroundColor={background}>
                   ...
                   {/*MENU ITEMS - just copy paste line 70 to line 108*/}
